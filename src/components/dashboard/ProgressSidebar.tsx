...
const ProgressSidebar = () => {
  ...
  if (loading) {
    return (
      <div className='w-full h-96 bg-accent border-l border-gray-200 p-4 flex items-center justify-center'>
        <div className='animate-spin rounded-full h-8 w-8 border-b-2 border-primary'></div>
      </div>
    );
  }
  return (
    <div className='w-full bg-accent border-b border-border p-8'>
      <div className='grid grid-cols-12 gap-4'>
        <div className='col-span-full'>
          <h2 className='text-4xl font-semibold lg:text-5xl 2xl:text-6xl'>
